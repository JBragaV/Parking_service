...
SECRET_KEY = 'django-insecure-7at41km274gmhnl1b5qep4+p7ukjxc-6#wc1wl!q$2tgb57u@j'
...
STATIC_URL = 'static/'
STATICFILES_DIR = [BASE_DIR / 'static']  # Meus staticos
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Staticos do Django
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Parking Services",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Parking Services",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Parking Services",
