# Generated by Django 5.2.6 on 2025-09-08 00:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parking_spot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='parking_spot', to='parking.parkingspot', verbose_name='Vaga')),
            ],
            options={
